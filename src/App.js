            ...
            <div className="container">
              ...
              <div className="columns">
                ...
                <div className="item">
                  ...
                  <img src="http://lorempixel.com/600/200/cats" alt="Sample Image" className="item-image" /></div>
              </div>
            </div>
          </article>
          ...
          <article className="post">
            <div className="container">
              ...
              <div className="columns thirds">
                <div className="item"> <h4 className="item-title">This is the post title</h4>
                  <img src="http://lorempixel.com/400/100/nature" alt="Sample Image" className="item-image" />
                ...
                <div className="item">
                  ...
                  <p><img src="http://lorempixel.com/400/100/cats" alt="Sample Image" className="item-image" />
                  </p>
                  <div className="social">
                    <a href="#"><i className="fa fa-facebook"></i></a>
                    <a href="#"><i className="fa fa-twitter"></i></a>
                ...
                <div className="item">
                  ...
                  <h4 className="item-title">This is the post title</h4>
                  <img src="http://lorempixel.com/400/100/fashion" alt="Sample Image" className="item-image" />
                ...
                <div className="item">
                  ...
                  <h4 className="item-title">This is the post title</h4>
                  <img src="http://lorempixel.com/400/100/nightlife" alt="Sample Image" className="item-image" />
